<!-- =============================================================
     DASHBOARD KHUSUS ROLE LOGISTIK
     ============================================================= -->
<div class="mb-4">
        ...
        <div class="col-12 col-sm-6 col-xl-4">
            <div class="stat-card bg-white p-3 rounded shadow-sm border border-warning-subtle d-flex align-items-center h-100 hover-opacity" onclick="window.location.href='<?= BASE_URL ?>/admin/pages/request_order/index.php'">
                ...
                <div class="stat-details overflow-hidden">
                    <div class="stat-label text-truncate text-muted small fw-semibold">Request Masuk</div>
                    <div class="stat-value text-dark fs-4 fw-bold font-monospace" id="statSubmitted">0</div>
                </div>
            </div>
        </div>
        <div class="col-12 col-sm-6 col-xl-4">
            <div class="stat-card bg-white p-3 rounded shadow-sm border border-primary-subtle d-flex align-items-center h-100 hover-opacity" onclick="window.location.href='<?= BASE_URL ?>/admin/pages/request_order/index.php'">
                ...
                <div class="stat-details overflow-hidden">
                    <div class="stat-label text-truncate text-muted small fw-semibold">Sedang Diproses</div>
                    <div class="stat-value text-primary fs-4 fw-bold font-monospace" id="statProcessing">0</div>
                </div>
            </div>
        </div>
        <div class="col-12 col-sm-6 col-xl-4">
...
document.addEventListener('DOMContentLoaded', async () => {
    try {
        ...
        console.error('Error loading logistik dashboard:', err);
    }
});
</script>
