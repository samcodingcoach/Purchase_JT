<!-- =============================================================
     DASHBOARD KHUSUS ROLE PURCHASING
     ============================================================= -->
<div class="mb-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h5 class="fs-6 fw-bold text-dark mb-0">
            <i class="bi bi-cart-check-fill me-2 text-primary"></i>Status Pengadaan &amp; PO
        </h5>
        <a href="<?= BASE_URL ?>/admin/pages/purchase_order/index.php" class="btn btn-sm btn-primary fw-semibold shadow-sm">
            <i class="bi bi-receipt me-1"></i>Kelola PO
        </a>
    </div>
    ...
    <div class="row g-3">
        <div class="col-12 col-sm-6 col-xl-3">
            <div class="stat-card bg-white p-3 rounded shadow-sm border border-secondary-subtle d-flex align-items-center h-100 hover-opacity" onclick="window.location.href='<?= BASE_URL ?>/admin/pages/request_order/index.php'">
                ...
                <div class="stat-details overflow-hidden">
                    <div class="stat-label text-truncate text-muted small fw-semibold">Total Draft</div>
        ...
        <div class="col-12 col-sm-6 col-xl-3">
            <div class="stat-card bg-white p-3 rounded shadow-sm border border-warning-subtle d-flex align-items-center h-100 hover-opacity" onclick="window.location.href='<?= BASE_URL ?>/admin/pages/request_order/index.php'">
                ...
                <div class="stat-details overflow-hidden">
                    <div class="stat-label text-truncate text-muted small fw-semibold">Menunggu Logistik</div>
        ...
        <div class="col-12 col-sm-6 col-xl-3">
            <div class="stat-card bg-white p-3 rounded shadow-sm border border-info-subtle d-flex align-items-center h-100 hover-opacity" onclick="window.location.href='<?= BASE_URL ?>/admin/pages/request_order/index.php'">
                ...
                <div class="stat-details overflow-hidden">
                    <div class="stat-label text-truncate text-muted small fw-semibold">Siap Proses PO</div>
                    <div class="stat-value text-info-emphasis fs-4 fw-bold font-monospace" id="statProcessing">0</div>
                </div>
            </div>
        </div>
        <div class="col-12 col-sm-6 col-xl-3">
            <div class="stat-card bg-white p-3 rounded shadow-sm border border-success-subtle d-flex align-items-center h-100 hover-opacity" onclick="window.location.href='<?= BASE_URL ?>/admin/pages/purchase_order/index.php'">
                ...
                <div class="stat-details overflow-hidden">
                    <div class="stat-label text-truncate text-muted small fw-semibold">PO Selesai (Diterima)</div>
