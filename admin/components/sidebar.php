...
<aside class="sidebar-wrapper app-sidebar" id="sidebarWrapper">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="<?= BASE_URL ?>/admin/dashboard.php" class="sidebar-link <?= (strpos($currentUri, 'dashboard') !== false) ? 'active' : '' ?>">
        ...
        <a href="<?= BASE_URL ?>/admin/pages/request_order/index.php" class="sidebar-link <?= (strpos($currentUri, 'request_order') !== false && strpos($currentUri, 'create.php') === false) ? 'active' : '' ?>">
            <i class="bi bi-file-earmark-text-fill"></i>
            <span>Request Order (RO)</span>
        </a>

        <?php if (in_array($userRole, [ROLE_MEKANIK, ROLE_ADMIN])): ?>
        <a href="<?= BASE_URL ?>/admin/pages/request_order/create.php" class="sidebar-link <?= (strpos($currentUri, 'create.php') !== false) ? 'active' : '' ?>" style="padding-left: 2rem;">
        ...
        <!-- 1. Profil Perusahaan -->
        <a href="<?= BASE_URL ?>/admin/pages/profile/index.php" class="sidebar-link <?= (strpos($currentUri, 'profile') !== false) ? 'active' : '' ?>">
            <i class="bi bi-buildings"></i>
            <span>Profil Perusahaan</span>
        </a>

        <!-- 2. Master Divisi -->
        <a href="<?= BASE_URL ?>/admin/pages/divisi/index.php" class="sidebar-link <?= (strpos($currentUri, 'divisi') !== false) ? 'active' : '' ?>">
        ...
        <!-- 4. Master Karyawan -->
        <a href="<?= BASE_URL ?>/admin/pages/user/index.php" class="sidebar-link <?= (strpos($currentUri, 'pages/user') !== false || strpos($currentUri, 'pages/karyawan') !== false) ? 'active' : '' ?>">
            <i class="bi bi-people-fill"></i>
            <span>Master Karyawan</span>
        </a>

        <!-- 5. Master Vendor -->
        <a href="<?= BASE_URL ?>/admin/pages/vendor/index.php" class="sidebar-link <?= (strpos($currentUri, 'vendor') !== false) ? 'active' : '' ?>">
            <i class="bi bi-truck"></i>
            <span>Master Vendor</span>
        </a>

        <!-- 6. Kelompok Master Barang (Expand & Collapse) -->
        <a class="sidebar-link <?= $isBarangActive ? 'active' : '' ?>" data-bs-toggle="collapse" href="javascript:void(0)" data-bs-target="#collapseBarang" role="button" aria-expanded="<?= $isBarangActive ? 'true' : 'false' ?>" aria-controls="collapseBarang">
        ...
        <div class="collapse <?= $isBarangActive ? 'show' : '' ?>" id="collapseBarang">
            <div class="sidebar-submenu">
                <a href="<?= BASE_URL ?>/admin/pages/kategori/index.php" class="sidebar-sublink <?= (strpos($currentUri, 'kategori') !== false) ? 'active' : '' ?>">
                    <i class="bi bi-tags"></i>
                    <span>Kategori Barang</span>
                </a>
                <a href="<?= BASE_URL ?>/admin/pages/merk/index.php" class="sidebar-sublink <?= (strpos($currentUri, 'merk') !== false) ? 'active' : '' ?>">
                    <i class="bi bi-bookmark-star"></i>
                    <span>Merk Barang</span>
                </a>
                <a href="<?= BASE_URL ?>/admin/pages/barang/index.php" class="sidebar-sublink <?= (strpos($currentUri, 'pages/barang') !== false) ? 'active' : '' ?>">
